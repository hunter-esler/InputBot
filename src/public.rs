    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            ...
            match self {
                ...
                KeybdKey::MultiplyKey => "Multiply",
                KeybdKey::AddKey => "Add",
                KeybdKey::SubtractKey => "Subtract",
                KeybdKey::DecimalKey => "Decimal",
                KeybdKey::DivideKey => "Divide",
                KeybdKey::F1Key => "F1",
                KeybdKey::F2Key => "F2",
                KeybdKey::F3Key => "F3",
                KeybdKey::F4Key => "F4",
...
pub fn from_keybd_key(k: KeybdKey) -> Option<char> {
    match k {
        ...
        KeybdKey::MultiplyKey => Some('*'),
        KeybdKey::AddKey => Some('+'),
        KeybdKey::SubtractKey => Some('-'),
        KeybdKey::DecimalKey => Some('.'),
        KeybdKey::DivideKey => Some('/'),
...
pub fn get_keybd_key(c: char) -> Option<KeybdKey> {
    match c {
        ...
        '*' => Some(KeybdKey::MultiplyKey),
        '-' => Some(KeybdKey::SubtractKey),
        '+' => Some(KeybdKey::AddKey),
        '/' => Some(KeybdKey::DivideKey),
        _ => None,
    }
}
